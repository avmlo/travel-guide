          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-4 md:gap-6">
            {cities.map((cityData, index) => (
              <button
                ...
                className="border border-gray-200 dark:border-gray-700 hover:border-black dark:hover:border-white hover:shadow-lg transition-all duration-200 bg-white dark:bg-gray-900 animate-scale-in p-6 text-left focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black dark:focus:ring-white"
                style={{ animationDelay: `${Math.min(index * 20, 400)}ms` }}
              >
                <h3 className="text-base font-bold uppercase mb-2 hover:opacity-60 transition-opacity text-black dark:text-white">
