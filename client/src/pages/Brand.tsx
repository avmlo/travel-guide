...
// Helper function to format brand slug to display name
...
export default function Brand() {
  ...
  useEffect(() => {
    async function loadBrandDestinations() {
      setLoading(true);
      ...
      if (error) {
        console.error('Error loading brand destinations:', error);
      } else if (data) {
        ...
        <div className="max-w-[1920px] mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-600">
              {destinations.length} {destinations.length === 1 ? 'destination' : 'destinations'} by {brandName}
            </p>
          </div>
          ...
          {destinations.length === 0 ? (
            <div className="text-center py-16">
              <p className="text-gray-400">No destinations found for this brand</p>
            </div>
          ) : (
